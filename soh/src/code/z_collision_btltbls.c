...
static DamageTable sHammerDamageTablePresets[] = {
    { {
        // 0
        /* Deku nut      */ DMG_ENTRY(0, 0x1),
        /* Deku stick    */ DMG_ENTRY(1, 0x0),
    ...
    { {
        ...
        /* Unknown 1     */ DMG_ENTRY(0, 0x0),
        /* Unblockable   */ DMG_ENTRY(0, 0x0),
        /* Hammer jump   */ DMG_ENTRY(2, 0x0), //unsure what uses this one - why are the other jumps 0? Still, this is a cheat, so double
        /* Unknown 2     */ DMG_ENTRY(0, 0x0),
    } },
    { {
        // 6
...
DamageTable* DamageTable_Get(s32 index) {
    ...
    if (CVarGetInteger("gHammerJumpSlashDamage", 0) != 0) {
        return &sHammerDamageTablePresets[index];
    } else {
